...
| [Python](http://www.python.org/) | 2.7.5 | Python programming language with standard library |
|:---------------------------------|:------|:--------------------------------------------------|
...
| [ipython](http://ipython.org) | 0.13.2 | Enhanced Python shell |
...
| [logilab-common](http://pypi.python.org/pypi/logilab-common) | 0.59.1 | Collection of low-level Python packages and modules used by Logilab projects (required for pylint) |
